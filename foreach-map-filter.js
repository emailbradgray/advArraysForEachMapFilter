...
*/
//let test = doubleValues(10,15,28);
//console.log(test + "this is test");

//why cant I (or how to) access values in new array?
//console double values and pass in arguements?
...
function doubleValues(arr) {
    ...
    console.log(newArr)
     arr.forEach(function(val) {
      console.log(val + " is orginal val")
        newArr.push(val * 2);   
    }); 
    console.log("this is a test of what is in newArr ex 1 " + newArr)
    return newArr;
  }
...
*/
    ...
    function onlyEvenValues(arr) {
        console.log("this is orignial array for ex 2 " + arr)
        let newArr = [];
        console.log(newArr)
        arr.forEach(function(val) {
            console.log("this is the original val " + val)
         if (val % 2 === 0) {
           newArr.push(val);
        }
       });
       console.log("this is a test of what is in newArr ex 2 " + newArr)
       return newArr;
      }
...
console.log("this is a test of what is in newArr ex 3 " + newArr) 
return newArr;
}
...
*/
//why cant I (or how to) access values in object?


 function addKeyAndValue(arr, key, value) {
    console.log("this is orignial array of objects for ex 4 " + arr[0])
   
    arr.forEach(function(val) {
        //console.log("this is the original val " + val);
        val[key] = value;
        console.log("this val upates the objects to show the title as " + value)
        
       });
       console.log("this is a test of what is in newArr ex 4 " + arr[0]) 
       return arr;
}
...
function vowelCount(str){
    console.log("this is original string for ex 5 " + str)
    let splitArr = str.split("");
    console.log("letters split into array " + splitArr)
  let obj = {};
  console.log(obj);
  const vowels = "aeiou";
...
function doubleValuesWithMap(arr) {
    console.log("this is array for ex 6 " + arr)
    return arr.map(function(val) {
        console.log("this is original val for ex 6 " + arr)
